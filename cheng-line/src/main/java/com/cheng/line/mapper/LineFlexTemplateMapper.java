...
/**
 * LINE Flex 自訂範本 Mapper 介面
 *
 * @author cheng
 */
@Mapper
public interface LineFlexTemplateMapper {
    ...
    /**
     * 查詢使用者可用的 Flex 範本（私人 + 公開）
     *
     * @param creatorId 使用者ID
     * @return Flex 範本列表
     */
    List<LineFlexTemplate> selectAvailableFlexTemplates(@Param("creatorId") Long creatorId);
