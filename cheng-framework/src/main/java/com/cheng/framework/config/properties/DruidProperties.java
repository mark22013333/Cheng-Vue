...
public class DruidProperties
{
    ...
    public DruidDataSource dataSource(DruidDataSource datasource)
    {
        ...
        /** 建议配置為true，不影響性能，並且保證安全性。申請連線的時候檢測，如果閒置時間大於timeBetweenEvictionRunsMillis，執行validationQuery檢測連線是否有效。 */
        datasource.setTestWhileIdle(testWhileIdle);
        /** 申請連線時執行validationQuery檢測連線是否有效，做了這個配置會降低性能。 */
        datasource.setTestOnBorrow(testOnBorrow);
        /** 歸還連線時執行validationQuery檢測連線是否有效，做了這個配置會降低性能。 */
