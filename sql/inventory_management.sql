...
VALUES (1000, 0, '辦公用品', 'OFFICE', 1, '0', '0', 'admin', NOW(), '', NULL, '辦公室日常用品'),
       (1001, 1000, '文具用品', 'STATIONERY', 1, '0', '0', 'admin', NOW(), '', NULL, '筆、紙張等文具'),
       (1002, 1000, '辦公設備', 'EQUIPMENT', 2, '0', '0', 'admin', NOW(), '', NULL, '印表機、掃描器等設備'),
       (2000, 0, '電子產品', 'ELECTRONICS', 2, '0', '0', 'admin', NOW(), '', NULL, '電子設備和配件'),
       (2001, 2000, '電腦設備', 'COMPUTER', 1, '0', '0', 'admin', NOW(), '', NULL, '電腦、筆電、平板等'),
       (2002, 2000, '網路設備', 'NETWORK', 2, '0', '0', 'admin', NOW(), '', NULL, '路由器、交換器等'),
       (3000, 0, '家具用品', 'FURNITURE', 3, '0', '0', 'admin', NOW(), '', NULL, '辦公家具'),
...
VALUES (10001, 'ITEM001', '原子筆-黑色', 1001, '4710123456789', '', '0.7mm', '支', 'Pilot', 'BPS-GP', 15.00, 15.00,
        'ABC文具行', 50, 200, 'A區-1層-1號', '黑色原子筆，書寫流暢', '', '0', '0', 'admin', NOW(), '', NULL,
        '常用辦公文具'),
       (10002, 'ITEM002', 'A4影印紙', 1001, '4710123456790', '', '80磅', '包', 'Double A', 'A4-80', 120.00, 120.00,
        'XYZ紙業', 10, 50, 'A區-2層-1號', 'A4白色影印紙，500張/包', '', '0', '0', 'admin', NOW(), '', NULL,
        '辦公室必需品'),
       (10003, 'ITEM003', '雷射印表機', 1002, '4710123456791', '', 'A4黑白雷射', '台', 'HP', 'LaserJet Pro M404n',
