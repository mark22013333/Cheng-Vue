...
public class ShopCategoryController extends BaseController {
     ...
     * 查詢分類列表
     */
    @PreAuthorize("@ss.hasPermi('" + PermConstants.Shop.Category.LIST + "')")
    @GetMapping("/list")
     ...
     * 查詢分類詳情
     */
    @PreAuthorize("@ss.hasPermi('" + PermConstants.Shop.Category.QUERY + "')")
     ...
     * 新增分類
     */
    @PreAuthorize("@ss.hasPermi('" + PermConstants.Shop.Category.ADD + "')")
     ...
     * 修改分類
     */
    @PreAuthorize("@ss.hasPermi('" + PermConstants.Shop.Category.EDIT + "')")
     ...
     * 刪除分類
     */
    @PreAuthorize("@ss.hasPermi('" + PermConstants.Shop.Category.REMOVE + "')")
