...
/**
 * 根據縣市代碼取得區域列表
 * @param {string} cityCode - 縣市代碼
 */
export function getDistrictList(cityCode) {
  return taiwanDistricts[cityCode] || []
}
 ...
 * 根據縣市代碼和區域名稱取得郵遞區號
 * @param {string} cityCode - 縣市代碼
 * @param {string} districtName - 區域名稱
 */
export function getPostalCode(cityCode, districtName) {
  const districts = taiwanDistricts[cityCode]
  if (!districts) return ''
  const district = districts.find(d => d.name === districtName)
  return district ? district.zip : ''
}
