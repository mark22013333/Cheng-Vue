...
const rawLogs = [
  {
    ...
    "date": "2026-01-12",
    "items": [
      "庫存管理功能升級：新增「物品標籤」功能，您現在可以在列表直接查看標籤，並透過標籤快速篩選出特定類別的物品。",
      "庫存編輯優化：在庫存物品的新增與編輯視窗中，已整合標籤設定功能，管理物品屬性更直覺。",
      "LINE 會員管理強化：支援「會員標籤」顯示與篩選，讓您更精準地掌握不同群組的會員資料。",
      "新增 LINE 會員編輯功能：現在可以直接在後台修改會員的「標籤設定」、「關注狀態」（如加入黑名單）以及「綁定狀態」，提升客服與運營效率。",
      "介面體驗優化：列表中的標籤顯示採用自動折疊設計，當標籤數量過多時將自動收合，保持版面整潔。"
    ]
  },
  {
    "version": "v2.3.7",
    "date": "2026-01-10",
    "items": [
      "公告系統體驗升級：通知中心現在提供「查看全部公告」快速連結，並在公告列表中新增「查看」功能，透過彈窗即可輕鬆閱讀包含圖片的完整公告內容。",
      "LINE 模組穩定性優化：修正了快速回覆 (Quick Reply) 訊息的格式驗證邏輯，解決因欄位空白導致發送失敗的問題，並提升編輯器的操作流暢度。",
      "系統核心升級：更新前端核心框架與建置流程，提升系統運作效能與開發穩定性。"
    ]
  },
  {
    "version": "v2.3.6",
