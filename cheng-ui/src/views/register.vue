  ...
  <div class="register">
    <el-form ref="registerForm" :model="registerForm" :rules="registerRules" class="register-form">
      ...
      <el-form-item prop="username">
        <el-input v-model="registerForm.username" auto-complete="off" placeholder="帳號" type="text">
      ...
      <el-form-item style="width:100%;">
        ...
        <div style="float: right;">
          <router-link :to="'/login'" class="link-type">使用已有帳號登入</router-link>
        </div>
      </el-form-item>
    </el-form>
    <!--  底部  -->
    <div class="el-register-footer">
      <span>Copyright © 2025–present cheng.vip All Rights Reserved.</span>
    </div>
  </div>
</template>
