   ...
   <div class="app-container">
      ...
      <el-row :gutter="10" class="mb8">
         ...
         <el-col :span="1.5">
            <el-button
               ...
               :disabled="multiple"
               @click="handleDelete"
               v-hasPermi="[SYSTEM_NOTICE_REMOVE]"
            >刪除</el-button>
         </el-col>
      ...
      <el-table v-loading="loading" :data="noticeList" @selection-change="handleSelectionChange">
         ...
         <el-table-column label="操作" align="center" width="150" class-name="small-padding fixed-width" fixed="right">
            <template #default="scope">
               <el-button link type="primary" icon="View" @click="handleView(scope.row)" v-hasPermi="[SYSTEM_NOTICE_QUERY]">查看</el-button>
               <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="[SYSTEM_NOTICE_EDIT]">修改</el-button>
               <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="[SYSTEM_NOTICE_REMOVE]" >刪除</el-button>
            </template>
         </el-table-column>
      </el-table>
...
function handleDelete(row) {
  ...
  proxy.$modal.confirm('是否確認刪除公告編號為"' + noticeIds + '"的資料選項？').then(function() {
