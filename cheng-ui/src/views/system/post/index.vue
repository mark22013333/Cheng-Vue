  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="狀態" prop="status">
        <el-select v-model="queryParams.status" clearable placeholder="職位狀態">
          <el-option
    ...
    <el-table v-loading="loading" :data="postList" @selection-change="handleSelectionChange">
      ...
      <el-table-column align="center" label="職位編號" prop="postId"/>
      <el-table-column align="center" label="職位編碼" prop="postCode"/>
      <el-table-column align="center" label="職位名稱" prop="postName"/>
      <el-table-column align="center" label="職位排序" prop="postSort"/>
