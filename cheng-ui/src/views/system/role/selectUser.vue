<template>
   <!-- 授權使用者 -->
   <el-dialog title="選擇使用者" v-model="visible" width="800px" top="5vh" append-to-body>
      ...
      <el-row>
         <el-table @row-click="clickRow" ref="refTable" :data="userList" @selection-change="handleSelectionChange" height="260px" class="custom-table">
...
function handleSelectUser() {
  ...
  if (uIds == "") {
    proxy.$modal.msgError("請選擇要分配的使用者")
    return
  }
