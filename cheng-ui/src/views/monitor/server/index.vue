<template>
  <div class="app-container">
    <el-row :gutter="10">
          ...
          <div class="el-table el-table--enable-row-hover el-table--medium">
            <table cellspacing="0" style="width: 100%;">
              ...
              <tbody>
                ...
                <tr>
                  <td class="el-table__cell is-leaf"><div class="cell">目前閒置率</div></td>
      ...
      <el-col :span="12" class="card-box">
        <el-card>
          <template #header><Tickets style="width: 1em; height: 1em; vertical-align: middle;" /> <span style="vertical-align: middle;">記憶體</span></template>
          <div class="el-table el-table--enable-row-hover el-table--medium">
            <table cellspacing="0" style="width: 100%;">
              <thead>
                <tr>
              ...
              <tbody>
                ...
                <tr>
                  <td class="el-table__cell is-leaf"><div class="cell">剩余記憶體</div></td>
      ...
      <el-col :span="24" class="card-box">
        <el-card>
          <template #header><Monitor style="width: 1em; height: 1em; vertical-align: middle;" /> <span style="vertical-align: middle;">伺服器訊息</span></template>
          <div class="el-table el-table--enable-row-hover el-table--medium">
            <table cellspacing="0" style="width: 100%;">
              <tbody>
                <tr>
      ...
      <el-col :span="24" class="card-box">
        <el-card>
          <template #header><CoffeeCup style="width: 1em; height: 1em; vertical-align: middle;" /> <span style="vertical-align: middle;">Java虛擬機訊息</span></template>
          <div class="el-table el-table--enable-row-hover el-table--medium">
            <table cellspacing="0" style="width: 100%;table-layout:fixed;">
              <tbody>
                ...
                <tr>
                  ...
                  <td class="el-table__cell is-leaf"><div class="cell">執行時間</div></td>
                ...
                <tr>
                  <td colspan="1" class="el-table__cell is-leaf"><div class="cell">執行參數</div></td>
      ...
      <el-col :span="24" class="card-box">
        <el-card>
          <template #header><MessageBox style="width: 1em; height: 1em; vertical-align: middle;" /> <span style="vertical-align: middle;">磁碟狀態</span></template>
          <div class="el-table el-table--enable-row-hover el-table--medium">
            <table cellspacing="0" style="width: 100%;">
              <thead>
                <tr>
                  <th class="el-table__cell el-table__cell is-leaf"><div class="cell">磁碟代號路徑</div></th>
                  <th class="el-table__cell is-leaf"><div class="cell">文件系統</div></th>
                  <th class="el-table__cell is-leaf"><div class="cell">磁碟代號類型</div></th>
