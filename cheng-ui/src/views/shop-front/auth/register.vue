        ...
        <template v-if="currentStep === 2">
          <div class="success-panel">
            <div class="success-icon">
              <el-icon :size="56" style="color: var(--mall-primary, #4A6B7C)"><Message /></el-icon>
            </div>
            <h2>驗證信已發送</h2>
            <p>我們已寄送驗證連結至</p>
...
.skeleton-title { width: 180px; height: 32px; margin-bottom: 10px; }
.skeleton-subtitle { width: 280px; height: 16px; }
...
.skeleton-check { width: 200px; height: 16px; }
.skeleton-btn { width: 100%; height: 50px; border-radius: 14px; margin-top: 4px; }
.skeleton-footer { width: 140px; height: 16px; align-self: center; }
...
.captcha-btn:hover {
  border-color: color-mix(in srgb, var(--mall-primary, #4A6B7C) 30%, transparent);
...
.captcha-mask {
  ...
  background: color-mix(in srgb, var(--mall-primary, #4A6B7C) 55%, transparent);
