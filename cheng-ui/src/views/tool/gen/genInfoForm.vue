    ...
    <el-row>
      ...
      <el-col :span="12">
        <el-form-item prop="genType">
          <span slot="label">
            產生程式碼方式
            <el-tooltip content="預設為zip壓縮包下載，也可以自定義產生路徑" placement="top">
              <i class="el-icon-question"></i>
            </el-tooltip>
          </span>
      ...
      <el-col :span="24" v-if="info.genType == '1'">
        <el-form-item prop="genPath">
          <span slot="label">
            自定義路徑
            <el-tooltip content="填寫硬碟絕對路徑，若不填寫，則產生到目前Web專案下" placement="top">
              <i class="el-icon-question"></i>
            </el-tooltip>
          </span>
          <el-input v-model="info.genPath">
            <el-dropdown slot="append">
              ...
              <el-dropdown-menu slot="dropdown">
                <el-dropdown-item @click.native="info.genPath = '/'">恢複預設的產生基礎路徑</el-dropdown-item>
              </el-dropdown-menu>
            </el-dropdown>
          </el-input>
        </el-form-item>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        tplCategory: [
          {required: true, message: "請選擇產生模板", trigger: "blur"}
        ],
        packageName: [
          {required: true, message: "請輸入產生包路徑", trigger: "blur"}
        ],
        moduleName: [
          {required: true, message: "請輸入產生模組名", trigger: "blur"}
        ],
        businessName: [
          {required: true, message: "請輸入產生業務名", trigger: "blur"}
        ],
        functionName: [
          {required: true, message: "請輸入產生功能名", trigger: "blur"}
        ]
      }
    }
  },
